...
I have a diverse background working in both public and private sectors from research to marketing which gives me a unique eye in which to approach your data-driven questions.
                            ...
                            <p class="text-gray-500 lg:max-w-md mt-3">I look forward to hearing about how I can help you solve your data questions!
                            </p>
        
                            <div class="flex items-center mt-6 -mx-2">
                                <a class="mx-2" href="https://twitter.com/jessicahoganma" target="_blank" aria-label="Twitter">
