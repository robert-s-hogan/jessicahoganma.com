<section class="pb-8 text-white text-center -mt-16">
	<div class="w-11/12 md:w-4/5 mx-auto bg-indigo-500 text-white rounded-lg shadow-lg overflow-hidden">
		<div class="flex flex-col md:flex-row md:items-center md:space-x-6 w-3/4 mx-auto justify-center py-8">
				...
				<button class="rounded-lg mx-auto mt-6 md:mt-0 md:py-3 md:px-4 md:rounded-full py-3 px-10 hover:text-white font-semibold border-2 md:w-1/4 bg-white hover:bg-indigo-500 text-indigo-500">
					Let's do this
				</button>
		</div>
	</div>
